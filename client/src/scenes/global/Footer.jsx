        ...
        <Box mt="70px" p="40px 0" backgroundColor={neutral.light}>
            <Box width="80%" margin="auto" display="flex" justifyContent="space-between" flexWrap="wrap" rowGap="30px" columnGap="clamp(20px, 30px, 40px)">
                <Box width="clamp(20%, 30%, 40%)">
                    ...
                    <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus modi iste voluptas libero voluptatum quod ratione! Ducimus, sequi recusandae quibusdam quae quaerat molestias eum. Culpa autem minus non repellendus dolores!</div>
                </Box>
                ...
                <Typography variant='h4' fontWeight="bold" mb="30px">Contact Us</Typography>
                    <Typography mb="30px">50 North Ham Blvd, Washington, DC 10501</Typography>
